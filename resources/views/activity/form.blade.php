        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row">
                        <h6 class="m-0 font-weight-bold text-primary">Ficha de Actividades</h6>
                    </div>
                </div>
                <form action="{{ (!empty($data->id)) ? route('activity.update',$data)  : route('activity.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @if (!empty($data->id))
                        @method('PATCH')
                    @endif
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombreProv">Proyectos:</label>
                                            <select class="form-control form-control-sm selectpicker show-tick" name="project_id" id="project_id" data-live-search="true" title="Etiquetas/Tags">                                    
